...
#                                         pzuv_total=row['Відходів в одиницях Пзув'], tonnes_1=row['Відходи I класу'],
